...
*How do Cal Poly students use their cell phones, and what patterns emerge in their daily screen time, app usage, and device habits?* This question anchors the cycle in authentic, personally meaningful data, creating immediate engagement and a sense of ownership over the analysis.
...
Students extract their own smartphone–usage survey from a CSV file exported from Google Forms or Qualtrics. Key goals:
...
Students produce simple, interpretable graphs that reflect their transformation choices and highlight patterns in usage behavior. Examples:
...
Students: - Navigate to a county-level GDP Wikipedia page or related table such as: - “List of U.S. counties by GDP,”\
- “List of counties in California by GDP,”\
- “Metropolitan areas by GDP,”\
- “U.S. states and counties ranked by economic growth.”\
- Identify which table contains usable GDP data, noting columns such as: - GDP (nominal),\
- GDP per capita,\
- GDP growth %,\
- Year of measurement.\
- Extract the table via `html_table()` and convert it into a tibble.

Reasoning: - County-level tables often vary in structure (e.g., different column orders, notes, symbols).\
...
Students: - Clean GDP fields by removing units (e.g., “\$”, “million”, “bn”) and converting them to numerics.\
...
- Create derived variables, such as: - GDP per capita (if not given),\
...
Reasoning: - Economic data often includes symbols, footnotes, or differing units; transformation must create a uniform scale.\
...
Students create visualizations such as: - Bar charts comparing GDP across counties.\
...
Reasoning: - Bar charts highlight economic magnitude; line plots highlight temporal change.\
...
Reasoning emphasizes: - JSON is inherently hierarchical; unnesting reflects “flattening” real-world structure.\
...
Reasoning emphasizes: - Time transformations shape the narrative structure of the analysis.\
...
Reasoning highlights: - Why line plots require correctly parsed time.\
